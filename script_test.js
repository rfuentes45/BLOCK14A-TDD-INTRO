...
describe("add", function () {
  describe("works with correct types", function (){
    it("is a function", function () {
      expect(code.add).to.be.a("function"); // REPLACE ME WAS HERE
    });

    it("returns a number", function () {
      expect(code.add(2, 2)).to.be.a("number"); // REPLACE ME WAS HERE
    });
  });
...
describe("subtract", function () {
  describe("works with correct types", function () {
    it("is a function", function () {
      expect(code.subtract).to.be.a("function"); // REPLACE ME WAS HERE
    });

    it("returns a number", function () {
      expect(code.subtract(2, 2)).to.be.a('number'); // REPLACE ME WAS HERE
    });
  });
  ...
  describe("returns the correct difference for random numbers between -50 and 50", function () {
    ...
    for (let i = 0; i < 3; i++) {
      const num1 = Math.floor(Math.random() * 100) - 50;
      const num2 = Math.floor(Math.random() * 100) - 50;
      const expected = num1 - num2; // REPLACE ME WAS HERE

      it(`returns ${expected} for ${num1} - ${num2}`, function () {
        const result = code.subtract(num1, num2);
        expect(result).to.equal(expected); // REPLACE ME HERE 
      });
    }
  });
});
...
describe("greet", function () {
  describe("works with correct types", function () {
    it("is a function", function () {
      expect(code.greet).to.be.a("function"); // REPLACE ME WAS HERE 
    });

    it("returns a string", function () {
      expect(code.greet()).to.be.a("string"); // REPLACE ME WAS HERE
    });
  });
  ...
  describe("returns the correct greeting", function () {
    it('returns "Hello!" when name is not provided', function () {
      ...
      expect(result).to.equal(result); // REPLACE ME WAS HERE
    });
...
describe("sum", function () {
  describe("works with correct types", function () {
    it("is a function", function () {
      expect(code.sum).to.be.a("function"); // REPLACE ME WAS HERE
    });

    it("returns a number", function () {
      expect(code.sum([0])).to.be.a ("number"); // REPLACE ME WAS HERE 
    });
  });
